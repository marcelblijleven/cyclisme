"""
Django settings for cyclisme project.
...
SECRET_KEY = 'django-insecure-n!b#jc^x67hnml@!akhjci(0_fo0e)=y+bvy=e8gyop+-4l75e'
...
INSTALLED_APPS = [
    ...
    'cyclisme.apps.base',
    'cyclisme.apps.authenticate',
    'cyclisme.apps.strava',
]
...
WSGI_APPLICATION = 'cyclisme.wsgi.application'
...
AUTHENTICATION_BACKENDS = [
    "cyclisme.apps.authenticate.backend.AuthBackend"
]
...
STRAVA_CALLBACK_URI = os.environ.get("STRAVA_CALLBACK_URI")
